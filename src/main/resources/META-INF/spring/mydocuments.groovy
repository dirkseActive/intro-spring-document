...
doc1(Document){
        name = "Book Template"
		type = ref("pdfType")
		location = "/Users/Documents/Book Template.pdf"
}

doc2(Document){
        name = "Sample Contract"
		type = ref("pdfType")
		location = "/Users/Documents/Contracts/Sample Contract.pdf"
}

doc3(Document){
        name = "Clustering with RabbitMQ"
		type = ref("noteType")
		location = "/Users/Documents/Random/Clustering with RabbitMQ.txt"
}
...
webType(com.apress.isf.java.model.Tykpe){
	name = "WEB"
	desc = "Web Link"
	extension = ".url"
}
